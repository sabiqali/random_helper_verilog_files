...
reg   [0:0] exitcond_reg_238_pp0_iter1_reg;
reg    fb_blk_n_B;
wire    ap_CS_fsm_state11;
reg   [10:0] t_V_1_reg_131;
wire  signed [32:0] sext_cast_fu_142_p1;
reg  signed [32:0] sext_cast_reg_219;
wire   [10:0] row_V_fu_152_p2;
reg   [10:0] row_V_reg_227;
wire    ap_CS_fsm_state2;
reg   [31:0] fb_addr_reg_232;
...
wire   [10:0] col_V_fu_213_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [7:0] tmp_3_reg_247;
reg    ap_sig_ioackin_m_axi_fb_AWREADY;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state4;
reg   [10:0] t_V_reg_120;
wire  signed [63:0] sum_cast_fu_197_p1;
reg    ap_reg_ioackin_m_axi_fb_AWREADY;
reg    ap_reg_ioackin_m_axi_fb_WREADY;
reg    ap_block_pp0_stage0_01001;
wire   [21:0] p_shl_fu_158_p3;
wire   [17:0] p_shl2_fu_170_p3;
wire   [22:0] p_shl_cast_cast_fu_166_p1;
wire   [22:0] p_shl2_cast_cast_fu_178_p1;
wire   [22:0] ret_V_fu_182_p2;
wire  signed [32:0] tmp_7_cast_fu_188_p1;
wire   [32:0] sum_fu_192_p2;
reg   [8:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_reg_238_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_207_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        t_V_1_reg_131 <= col_V_fu_213_p2;
    end else if (((1'b1 == ap_CS_fsm_state3) & (ap_sig_ioackin_m_axi_fb_AWREADY == 1'b1))) begin
        t_V_1_reg_131 <= 11'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        exitcond_reg_238 <= exitcond_fu_207_p2;
        exitcond_reg_238_pp0_iter1_reg <= exitcond_reg_238;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond1_fu_146_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        fb_addr_reg_232 <= sum_cast_fu_197_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        row_V_reg_227 <= row_V_fu_152_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        sext_cast_reg_219 <= sext_cast_fu_142_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_reg_238 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_3_reg_247 <= img_data_stream_V_dout;
    end
end

always @ (*) begin
    if ((exitcond_fu_207_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_reg_238_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_reg_238 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_reg_238 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((exitcond_reg_238_pp0_iter1_reg == 1'd0) & (ap_reg_ioackin_m_axi_fb_WREADY == 1'b0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_207_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_207_p2 == 1'd1)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_reg_238 == 1'd0) & (img_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((exitcond_reg_238 == 1'd0) & (img_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state6_io)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((exitcond_reg_238 == 1'd0) & (img_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state6_io)));
end

assign ap_block_state4_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((exitcond_reg_238 == 1'd0) & (img_data_stream_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state6_io = ((exitcond_reg_238_pp0_iter1_reg == 1'd0) & (ap_sig_ioackin_m_axi_fb_WREADY == 1'b0));
end
...
assign col_V_fu_213_p2 = (t_V_1_reg_131 + 11'd1);

assign exitcond1_fu_146_p2 = ((t_V_reg_120 == 11'd1080) ? 1'b1 : 1'b0);

assign exitcond_fu_207_p2 = ((t_V_1_reg_131 == 11'd1920) ? 1'b1 : 1'b0);
...
assign m_axi_fb_AWADDR = fb_addr_reg_232;
...
assign m_axi_fb_WDATA = tmp_3_reg_247;
...
assign p_shl2_cast_cast_fu_178_p1 = p_shl2_fu_170_p3;

assign p_shl2_fu_170_p3 = {{t_V_reg_120}, {7'd0}};

assign p_shl_cast_cast_fu_166_p1 = p_shl_fu_158_p3;

assign p_shl_fu_158_p3 = {{t_V_reg_120}, {11'd0}};

assign ret_V_fu_182_p2 = (p_shl_cast_cast_fu_166_p1 - p_shl2_cast_cast_fu_178_p1);

assign row_V_fu_152_p2 = (t_V_reg_120 + 11'd1);

assign sext_cast_fu_142_p1 = $signed(fb_offset);

assign sum_cast_fu_197_p1 = $signed(sum_fu_192_p2);

assign sum_fu_192_p2 = ($signed(tmp_7_cast_fu_188_p1) + $signed(sext_cast_reg_219));

assign tmp_7_cast_fu_188_p1 = $signed(ret_V_fu_182_p2);
