...
(* CORE_GENERATION_INFO="conv,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=1833,HLS_SYN_LUT=3761,HLS_VERSION=2018_3}" *)
...
wire    Block_proc9_U0_start_out;
wire    Block_proc9_U0_start_write;
wire   [11:0] Block_proc9_U0_src_rows_V_out_din;
wire    Block_proc9_U0_src_rows_V_out_write;
wire   [11:0] Block_proc9_U0_src_cols_V_out_din;
wire    Block_proc9_U0_src_cols_V_out_write;
wire   [31:0] Block_proc9_U0_image_in_out_din;
wire    Block_proc9_U0_image_in_out_write;
wire   [31:0] Block_proc9_U0_image_out_out_din;
...
wire   [11:0] src_rows_V_c24_dout;
wire    src_rows_V_c24_empty_n;
wire    src_cols_V_c25_full_n;
wire   [11:0] src_cols_V_c25_dout;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_Block_proc9_U0_ap_ready;
wire    ap_sync_Block_proc9_U0_ap_ready;
reg   [1:0] Block_proc9_U0_ap_ready_count;
...
initial begin
#0 ap_sync_reg_Block_proc9_U0_ap_ready = 1'b0;
#0 Block_proc9_U0_ap_ready_count = 2'd0;
...
Block_proc9 Block_proc9_U0(
    ...
    .start_out(Block_proc9_U0_start_out),
    .start_write(Block_proc9_U0_start_write),
    .src_rows_V_out_din(Block_proc9_U0_src_rows_V_out_din),
    .src_rows_V_out_full_n(src_rows_V_c_full_n),
    .src_rows_V_out_write(Block_proc9_U0_src_rows_V_out_write),
    .src_cols_V_out_din(Block_proc9_U0_src_cols_V_out_din),
    .src_cols_V_out_full_n(src_cols_V_c_full_n),
    .src_cols_V_out_write(Block_proc9_U0_src_cols_V_out_write),
    .image_in(image_in),
    .image_out(image_out),
    .image_in_out_din(Block_proc9_U0_image_in_out_din),
    .image_in_out_full_n(image_in_c_full_n),
    .image_in_out_write(Block_proc9_U0_image_in_out_write),
    .image_out_out_din(Block_proc9_U0_image_out_out_din),
    .image_out_out_full_n(image_out_c_full_n),
    .image_out_out_write(Block_proc9_U0_image_out_out_write)
);
...
Filter2D Filter2D_U0(
    ...
    .p_src_rows_V_dout(src_rows_V_c24_dout),
    .p_src_rows_V_empty_n(src_rows_V_c24_empty_n),
    .p_src_rows_V_read(Filter2D_U0_p_src_rows_V_read),
    .p_src_cols_V_dout(src_cols_V_c25_dout),
    .p_src_cols_V_empty_n(src_cols_V_c25_empty_n),
...
fifo_w12_d2_A src_rows_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_proc9_U0_src_rows_V_out_din),
    .if_full_n(src_rows_V_c_full_n),
    .if_write(Block_proc9_U0_src_rows_V_out_write),
...
fifo_w12_d2_A src_cols_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_proc9_U0_src_cols_V_out_din),
    .if_full_n(src_cols_V_c_full_n),
    .if_write(Block_proc9_U0_src_cols_V_out_write),
...
fifo_w32_d2_A image_in_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_proc9_U0_image_in_out_din),
    .if_full_n(image_in_c_full_n),
    .if_write(Block_proc9_U0_image_in_out_write),
...
fifo_w32_d4_A image_out_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_proc9_U0_image_out_out_din),
    .if_full_n(image_out_c_full_n),
    .if_write(Block_proc9_U0_image_out_out_write),
...
fifo_w12_d2_A src_rows_V_c24_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(AXIM2Mat_U0_img_rows_V_out_din),
    .if_full_n(src_rows_V_c24_full_n),
    .if_write(AXIM2Mat_U0_img_rows_V_out_write),
    .if_dout(src_rows_V_c24_dout),
    .if_empty_n(src_rows_V_c24_empty_n),
    .if_read(Filter2D_U0_p_src_rows_V_read)
);

fifo_w12_d2_A src_cols_V_c25_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(AXIM2Mat_U0_img_cols_V_out_din),
    .if_full_n(src_cols_V_c25_full_n),
    .if_write(AXIM2Mat_U0_img_cols_V_out_write),
    .if_dout(src_cols_V_c25_dout),
    .if_empty_n(src_cols_V_c25_empty_n),
...
start_for_Mat2AXIeOg start_for_Mat2AXIeOg_U(
    ...
    .if_write(Block_proc9_U0_start_write),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Block_proc9_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_Block_proc9_U0_ap_ready <= 1'b0;
        end else begin
            ap_sync_reg_Block_proc9_U0_ap_ready <= ap_sync_Block_proc9_U0_ap_ready;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_sync_ready == 1'b1) & (1'b0 == Block_proc9_U0_ap_ready))) begin
        Block_proc9_U0_ap_ready_count <= (Block_proc9_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Block_proc9_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Block_proc9_U0_ap_ready_count <= (Block_proc9_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_proc9_U0_ap_start = ((ap_sync_reg_Block_proc9_U0_ap_ready ^ 1'b1) & ap_start);
...
assign ap_idle = (Mat2AXIM_U0_ap_idle & Filter2D_U0_ap_idle & Block_proc9_U0_ap_idle & AXIM2Mat_U0_ap_idle);
...
assign ap_sync_Block_proc9_U0_ap_ready = (ap_sync_reg_Block_proc9_U0_ap_ready | Block_proc9_U0_ap_ready);

assign ap_sync_continue = 1'b1;

assign ap_sync_done = Mat2AXIM_U0_ap_done;

assign ap_sync_ready = (ap_sync_Block_proc9_U0_ap_ready & ap_sync_AXIM2Mat_U0_ap_ready);
